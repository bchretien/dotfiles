# From: https://github.com/maverick2000/zsh2000
...
prompt_git() {
  ...
  if $(git rev-parse --is-inside-work-tree >/dev/null 2>&1); then
    ...
    if [[ -n $dirty ]]; then
      prompt_segment ${ZSH_2000_GIT_DIRTY_BG} ${ZSH_2000_GIT_DIRTY_FG}
    else
      prompt_segment ${ZSH_2000_GIT_CLEAN_BG} ${ZSH_2000_GIT_CLEAN_FG}
    fi
